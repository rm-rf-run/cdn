!function (t) {
  ...
  o.loadJson = function (t) {
    ...
    if (i.setFadeIn(parseInt(r.fade_in) > 0 ? parseInt(r.fade_in)  : 1000), i.setFadeOut(parseInt(r.fade_out) > 0 ? parseInt(r.fade_out)  : 1000), null == r.params) return i;
    var s = r.params,
    _ = s.length;
    i.paramList = [
    ];
...
function (t, i, e) {
  ...
  function n(t) {
    ...
    B.setMaxScale(w.default.VIEW_MAX_SCALE), B.setMinScale(w.default.VIEW_MIN_SCALE), U = new M.L2DMatrix44, U.multScale(1, i / e), G = new M.L2DMatrix44, G.multTranslate( - i / 2, - e / 2), G.multScale(2 / i, - 2 / i), F = v(), (0, D.setContext) (F), !F) return console.error('Failed to create WebGL context.'), void (window.WebGLRenderingContext && console.error('Your browser don\'t support WebGL, check https://get.webgl.org/ for futher information.')); window.Live2D.setGL(F), F.clearColor(0, 0, 0, 0), a(t), s()
  }
  function s() {
    b || (b = !0, function t() {
      _();
  ...
  O = r(x),
  D = e(2),
  R = (window.navigator.platform.toLowerCase(), new A.default), b = !1, F = null, C = null, N = null, B = null, U = null, G = null, Y = !1, k = 0, V = 0, X = 0.5; window.loadlive2d = L
},
function (t, i, e) {
  'use strict';
  (function (t) {
    !function () {
      ...
      function s() {
        At || (this._$dP = null, this._$eo = null, this._$V0 = null, this._$dP = 1000, this._$eo = 1000, this._$V0 = 1, this._$a0())
      }
      function _() {
      }
      function a() {
      ...
      function V() {
        At || (this._$12 = null, this._$bb = null, this._$_L = null, this._$jo = null, this._$iL = null, this._$0L = null, this._$Br = null, this._$Dr = null, this._$Cb = null, this._$mr = null, this._$_L = wt.STATE_FIRST, this._$Br = 4000, this._$Dr = 100, this._$Cb = 50, this._$mr = 150, this._$jo = !0, this._$iL = 'PARAM_EYE_L_OPEN', this._$0L = 'PARAM_EYE_R_OPEN')
      }
      function X() {
      ...
      function St(t) {
        At || (this._$P = new Int8Array(8), this._$R0 = new DataView(this._$P.buffer), this._$3i = new Int8Array(1000), this._$hL = 0, this._$v0 = 0, this._$S2 = 0, this._$Ko = new Array, this._$T = t, this._$F = 0)
      }
      function vt() {
      }
      function Lt() {
      ...
      function Mt(t) {
        At || (this._$e0 = null, this._$IP = null, this._$Us = null, this._$7s = null, this._$IS = [
          !1
        ], this._$VS = null, this._$AT = !0, this.baseOpacity = 1, this.clipBufPre_clipContext = null, this._$e0 = t)
      }
      function Et() {
      }
      var At = !0;
      ...
      e.prototype.calcClippedDrawTotalBounds = function (t, i) {
        for (var e = t._$Ri.getModelImpl().getCanvasWidth(), r = t._$Ri.getModelImpl().getCanvasHeight(), o = e > r ? e : r, n = o, s = o, _ = 0, a = 0, h = i.clippedDrawContextList.length, l = 0; l < h; l++) {
          ...
          if (p._$yo()) {
            ...
            ], y = 0, m = U._$i2; m < c; m += U._$No) d[y] = f[m],
            g[y] = f[m + 1],
            y++;
      ...
      C.prototype.updateParamExe = function (t, i, e, r) {
        for (var o = i - r._$z2, n = o * this._$D0 / 1000, s = 0 | n, _ = n - s, a = 0; a < this.motions.length; a++) {
...
this != i._$GT() && console.log('### assert!! ### ');
for (var _, a, h = i, l = null != h._$Wr ? h._$Wr : h._$Yr, $ = Math.sin(Lt._$bS * l._$qT), u = Math.cos(Lt._$bS * l._$qT), p = h.getTotalScale(), f = l.reflectX ? - 1 : 1, c = l.reflectY ? - 1 : 1, d = u * p * f, g = - $ * p * c, y = $ * p * f, m = u * p * c, T = l._$fL, P = l._$gL, S = o * s, v = n; v < S; v += s) _ = e[v],
a = e[v + 1],
r[v] = d * _ + g * a + T,
r[v + 1] = y * _ + m * a + P
},
...
for (var _, a, h, l, $, u, p, f = i, c = this._$o, d = this._$A, g = o * s, y = null != f._$hr ? f._$hr : f._$Cr, m = n; m < g; m += s) at._$ts ? (_ = e[m], a = e[m + 1], _ < 0 ? _ = 0 : _ > 1 && (_ = 1), a < 0 ? a = 0 : a > 1 && (a = 1), _ *= c, a *= d, h = 0 | _, l = 0 | a, h > c - 1 && (h = c - 1), l > d - 1 && (l = d - 1), u = _ - h, p = a - l, $ = 2 * (h + l * (c + 1)))  : (_ = e[m] * c, a = e[m + 1] * d, u = _ - (0 | _), p = a - (0 | a), $ = 2 * ((0 | _) + (0 | a) * (c + 1))),
...
for (var t = 0; t < this.models.length; t++) this.models[t].startRandomMotion($.default.MOTION_GROUP_PINCH_OUT,
$.default.PRIORITY_NORMAL)
}, o.prototype.tapEvent = function (t, i) {
$.default.DEBUG_LOG && console.log('tapEvent view x:' + t + ' y:' + i);
for (var e = 0; e < this.models.length; e++) this.models[e].hitTest($.default.HIT_AREA_HEAD,
t,
i) ? ($.default.DEBUG_LOG && console.log('Tap face.'),
this.models[e].setRandomExpression()) : this.models[e].hitTest($.default.HIT_AREA_BODY,
t,
i) ? ($.default.DEBUG_LOG && console.log('Tap body. models[' + e + ']'),
this.models[e].startRandomMotion($.default.MOTION_GROUP_TAP_BODY,
$.default.PRIORITY_NORMAL)) : this.models[e].hitTestCustom('head', t, i) ? ($.default.DEBUG_LOG && console.log('Tap face.'),
this.models[e].startRandomMotion($.default.MOTION_GROUP_FLICK_HEAD,
$.default.PRIORITY_NORMAL)) : this.models[e].hitTestCustom('body', t, i) && ($.default.DEBUG_LOG && console.log('Tap body. models[' + e + ']'),
this.models[e].startRandomMotion($.default.MOTION_GROUP_TAP_BODY,
...
for (var t = 0; t < r.modelSetting.getInitParamNum(); t++) r.live2DModel.setParamFloat(r.modelSetting.getInitParamID(t), r.modelSetting.getInitParamValue(t)); for (var t = 0; t < r.modelSetting.getInitPartsVisibleNum(); t++) r.live2DModel.setPartsOpacity(r.modelSetting.getInitPartsVisibleID(t), r.modelSetting.getInitPartsVisibleValue(t)); r.live2DModel.saveParam(), r.preloadMotionGroup(h.default.MOTION_GROUP_IDLE), r.preloadMotionGroup(h.default.MOTION_GROUP_SLEEPY), r.mainMotionManager.stopAllMotions(), r.setUpdating(!1), r.setInitialized(!0), 'function' == typeof e && e()
}
})
}
})
...
if (null == this.live2DModel) return void (h.default.DEBUG_LOG && console.error('Failed to update.')); var t = UtSystem.getUserTimeMSec() - this.startTimeMSec, i = t / 1000, e = 2 * i * Math.PI; if (this.mainMotionManager.isFinished()) {
'1' === sessionStorage.getItem('Sleepy') ? this.startRandomMotion(h.default.MOTION_GROUP_SLEEPY,
h.default.PRIORITY_SLEEPY) :
this.startRandomMotion(h.default.MOTION_GROUP_IDLE,
...
if (null == r || '' == r) return void (h.default.DEBUG_LOG && console.error('Failed to motion.')); if (e == h.default.PRIORITY_FORCE) this.mainMotionManager.setReservePriority(e);  else if (!this.mainMotionManager.reserveMotion(e)) return void (h.default.DEBUG_LOG && console.log('Motion is running.')); var o, n = this; null == this.motions[t] ? this.loadMotion(null, this.modelHomeDir + r, function (r) {
o = r,
...
if (r.setFadeIn(this.modelSetting.getMotionFadeIn(t, i)), r.setFadeOut(this.modelSetting.getMotionFadeOut(t, i)), h.default.DEBUG_LOG && console.log('Start motion : ' + o),
null == this.modelSetting.getMotionSound(t, i)) this.mainMotionManager.startMotionPrio(r, e);  else {
...
i,
e) :
'body' == t && this.hitTestSimpleCustom(h.default.hit_areas_custom_body_x,
...
return null == this.json[this.MOTION_GROUPS] || null == this.json[this.MOTION_GROUPS][t] || null == this.json[this.MOTION_GROUPS][t][i] || null == this.json[this.MOTION_GROUPS][t][i][this.FADE_IN] ? 1000 : this.json[this.MOTION_GROUPS][t][i][this.FADE_IN]
},
r.prototype.getMotionFadeOut = function (t, i) {
return null == this.json[this.MOTION_GROUPS] || null == this.json[this.MOTION_GROUPS][t] || null == this.json[this.MOTION_GROUPS][t][i] || null == this.json[this.MOTION_GROUPS][t][i][this.FADE_OUT] ? 1000 : this.json[this.MOTION_GROUPS][t][i][this.FADE_OUT]
},
