...
$('.waifu-tool .drivers-license-o').click(function(){
    window.event? window.event.cancelBubble = true : e.stopPropagation();
    if(model_p===22){
        loadlive2d('live2d',$(".l2d_xb")+'http://localhost:8080/prettywordpress/wordpress/wp-content/plugins/poster-girl-l2d-2233-master'+'/model/api.php?p=22&id='+m22_id);
        model_p = 33;
        showMessage('33援交有点累了，现在该我上场了',4000)
    }else{
        loadlive2d('live2d',$(".l2d_xb")+'http://localhost:8080/prettywordpress/wordpress/wp-content/plugins/poster-girl-l2d-2233-master'+'/model/api.php?p=33&id='+m33_id);
        model_p = 22;
...
loadlive2d('live2d',$(".l2d_xb")+'http://localhost:8080/prettywordpress/wordpress/wp-content/plugins/poster-girl-l2d-2233-master'+'/model/api.php?p=33');
